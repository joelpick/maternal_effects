...
# Introduction
Maternal effects are common, especially in traits expressed in juveniles (Moore et al 2019).
 When the traits underlying the maternal effects have a genetic basis (i.e. maternal genetic effects), then the response to selection of these traits is no longer predicted by $V_A$ alone, with the 'total' $V_A$ being calculated as 
$$
V_A + 3/2 COV_{A,Mg} + 1/2 V_{Mg}
$$
(Willham, 1963;1972).
<!-- look at willham, kirkpatrick and lande etc - does that equation work with selection gradient to predict phenotypic change -->

Previous work has shown that not accounting for these maternal effects can bias estimates of $V_A$ (Clements et al 2001), including in empirical estimates of wild populations (e.g. Wilson et al 2005 Soay Sheep, Kruuk and Hadfield 2007 Red Deer
<!-- mcfarlane? -->
), and so in turn the total evolutionary potential of a trait. We do not know the systematically to what extent estimates of $V_A$ are affected, or how pedigree structure influences this (need to look more at Clements et al 2001).
...
<!-- Many studies have shown the presence maternal effects (N from moore et al) but by far the majority of which have not modelled maternal genetic effects. This is likely because of data constraints, and the assumption is maybe that this maternal genetic variation is captured by the maternal environment effect. From the few studies that have estimated maternal genetic effects, it is common for this maternal variation to have a considerable genetic component (check), which is corroborated by studies demonstrating genetic variation in parental care behaviours. Given this, it is important to understand to what extent the maternal genetic effects are captured by maternal environment, or whether they bias the estimation of Va. can also be correlated which will affect this.  furthermore if maternal genetic effects are not detected then total Va will be underestimated.   -->
